 ...
 * d'erreur HTTP cohérentes sur l'ensemble des endpoints du campagne-service.
 */
@RestControllerAdvice
public class GlobalExceptionHandler {

    @ExceptionHandler(CampagneNotFoundException.class)
    public ResponseEntity<ApiErrorResponse> gererCampagneNotFound(
            CampagneNotFoundException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiErrorResponse> gererAffectationInvalide(
            AffectationInvalideException ex, HttpServletRequest request) {
