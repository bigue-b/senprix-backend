 ...
 * d'erreur HTTP cohérentes sur l'ensemble des endpoints du export-service.
 */
@RestControllerAdvice
public class GlobalExceptionHandler {

    @ExceptionHandler(ExportImpossibleException.class)
    public ResponseEntity<ApiErrorResponse> gererExportImpossible(
            ExportImpossibleException ex, HttpServletRequest request) {
