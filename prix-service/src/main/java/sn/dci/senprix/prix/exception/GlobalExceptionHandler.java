 ...
 * d'erreur HTTP cohérentes sur l'ensemble des endpoints du prix-service.
 */
@RestControllerAdvice
public class GlobalExceptionHandler {

    @ExceptionHandler(PrixNotFoundException.class)
    public ResponseEntity<ApiErrorResponse> gererPrixNotFound(
            PrixNotFoundException ex, HttpServletRequest request) {
        return construireReponse(HttpStatus.NOT_FOUND, ex.getMessage(), request, null);
    }

    @ExceptionHandler(PrixInvalideException.class)
    public ResponseEntity<ApiErrorResponse> gererPrixInvalide(
            PrixInvalideException ex, HttpServletRequest request) {
