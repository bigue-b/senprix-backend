 ...
 * d'erreur HTTP cohérentes sur l'ensemble des endpoints du produit-service.
 */
@RestControllerAdvice
public class GlobalExceptionHandler {

    @ExceptionHandler(ProduitNotFoundException.class)
    public ResponseEntity<ApiErrorResponse> gererProduitNotFound(
            ProduitNotFoundException ex, HttpServletRequest request) {
        return construireReponse(HttpStatus.NOT_FOUND, ex.getMessage(), request, null);
    }

    @ExceptionHandler(MarcheNotFoundException.class)
    public ResponseEntity<ApiErrorResponse> gererMarcheNotFound(
            MarcheNotFoundException ex, HttpServletRequest request) {
        return construireReponse(HttpStatus.NOT_FOUND, ex.getMessage(), request, null);
    }
